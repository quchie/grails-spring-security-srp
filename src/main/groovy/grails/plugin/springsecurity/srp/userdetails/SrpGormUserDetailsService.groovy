 ...
 */
class SrpGormUserDetailsService implements GrailsUserDetailsService {
    ...
    protected UserDetails createUserDetails(user, Collection<GrantedAuthority> authorities) {
        ...
        String saltPropertyName = conf.srp.userLookup.saltPropertyName
        String verifierPropertyName = conf.srp.userLookup.verifierPropertyName
        ...
        String salt = user."$saltPropertyName"
        String verifier = user."$verifierPropertyName"

        new SrpGrailsUser(username, password, enabled, !accountExpired, !passwordExpired,
                !accountLocked, authorities, user.id,salt,verifier)
    }
}